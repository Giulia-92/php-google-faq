    ...
    [ 'DOMANDA'=>"Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al       diritto   all'oblio?",
        ...
        [ 'DOMANDA'=>"Perché il mio account è associato a un paese?",
         ...
         <li> Google LLC, con sede negli Stati Uniti, per il resto del mondo.</ul>
          ...
          Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.</ul>"
        ],
...
<?php for($i = 0; $i < count($answer); $i++){ ?>
    <li class="titolo"><strong>
     <?php   echo $answer[$i]['DOMANDA']; ?></strong></li>
       <li class="text">

       <?php echo $answer[$i]['RISPOSTA']; ?></li>
